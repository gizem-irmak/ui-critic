...
serve(async (req) => {
  ...
  try {
    ...
    if (selectedRulesSet.has('U4')) {
      ...
      // 3. Deterministic U4.1 candidates NOT addressed by LLM
      ...
      if (allU4Elements.length > 0) {
        ...
        if (confirmedEls.length > 0) {
          ...
          aggregatedU4GitHubList.push({
            ...
            inputType: 'github', isU4Aggregated: true, u4Elements: confirmedEls, evaluationMethod: 'hybrid_deterministic',
        ...
        if (potentialEls.length > 0) {
          ...
          aggregatedU4GitHubList.push({
            ...
            inputType: 'github', isU4Aggregated: true, u4Elements: potentialEls,
        ...
        console.log(`U4 aggregated (GitHub): ${confirmedEls.length} confirmed, ${potentialEls.length} potential`);
      } else {
